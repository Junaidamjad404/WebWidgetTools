...
Route::get('/api/auth/callback', function (Request $request) {
    ...
    // Associate all general modules with the shop
    $generalModules = GeneralModules::all(); // Fetch all general modules
   
    foreach ($generalModules as $module) {
        Modules::updateOrCreate(
            ['shop_id' => $session->shop, 'general_module_id' => $module->id],
            ['custom_settings' => $module->settings] // Default settings, can be adjusted later
        );
    }
